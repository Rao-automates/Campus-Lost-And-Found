IF NOT EXISTS(SELECT * FROM sys.databases WHERE name = 'CampusLostAndFound')
BEGIN
...
IF NOT EXISTS (
    ...
    WHERE [MigrationId] = N'20260528221304_InitialCreate'
)
BEGIN
...
BEGIN
    ...
    VALUES (N'20260528221304_InitialCreate', N'8.0.0');
END;
GO
